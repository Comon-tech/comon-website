...
function Navbar() {
  return (
    <div className="fixed top-0 w-full flex justify-between p-4 rounded-2xl bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 shadow-lg border border-[#3c3e44] z-50">
